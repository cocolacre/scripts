...
doskey admin=runas /savecred /env /user:Администратор cmd.exe

doskey tasks=%USERPROFILE%\Documents\sqlite\sqlite3.exe C:\Users\79951\Documents\Task-Stack-Widget\appdata.db "SELECT id, name FROM (SELECT id, name FROM tasks ORDER BY id DESC LIMIT 25) ORDER BY id ASC"
