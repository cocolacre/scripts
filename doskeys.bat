...
::net user vadim.phystech /active:yes
@echo off
color 0a
::chcp 65001
::echo see C:\%USERPROFILE%\keep-in-mind.txt (for example: registry backup)
::actual doskeys
::echo "PATH TO USER DIRECTORY:" %USERPROFILE%
::ld = load doskeys

doskey mears=cd C:\Users\79951\Documents\Task-Stack-Widget\task-data\2774  $T$T C:\Python39\python.exe "C:\Users\79951\Documents\Task-Stack-Widget\task-data\2774\measure_frequency_sensitivity-1.py"

doskey blender="C:\Program Files\Blender Foundation\Blender 2.93\blender.exe"
set bandicam=%USERPROFILE%\Documents\Bandicam
doskey keepinmind="C:\Program Files\Notepad++\notepad++.exe" %USERPROFILE%\keep-in-mind.txt
doskey ld="%USERPROFILE%\scripts\doskeys.bat"
doskey dsks="C:\Program Files\Notepad++\notepad++.exe" %USERPROFILE%\scripts\doskeys.bat
::doskey colors=type C:\Users\2\Documents\colors.txt
doskey blue=color 09
...
doskey vlc0=taskkill /f /im vlc.exe
doskey yt=C:\Python39\Scripts\youtube-dl.exe $*
doskey mesar=cd C:\Users\79951\Documents\Task-Stack-Widget\task-data\2771  $T$T C:\Python39\python.exe "C:\Users\79951\Documents\Task-Stack-Widget\task-data\2771\measure-physiology-reaction-v1.py"
doskey kr=%USERPROFILE%\scripts\keyrate\keyrate.cmd $*
:: 140 35
::doskey ffmpeg=C:\Windows\System32\ffmpeg.exe $*
::doskey fmpeg=C:\Users\2\ffmpeg.exe $*
...
doskey procexp="C:\Users\2\Downloads\ProcessExplorer\procexp.exe"
doskey p3=C:\Python39\python.exe -i $*
doskey p3pip=C:\Python39\python.exe -m pip $*
doskey p36=C:\Python36\python.exe -i $*
doskey p37=C:\Python37\python.exe -i $*
...
::FFMPEG
::doskey rec10=ffmpeg -f gdigrab -framerate 10 -video_size 1364x768 -i desktop out.mp4
doskey x2=ffmpeg -i $1 -filter:v "setpts=0.5*PTS" $2
doskey x10=ffmpeg -i $1 -filter:v "setpts=0.1*PTS" $2
doskey x50=ffmpeg -i $1 -filter:v "setpts=0.02*PTS" $2
doskey replace_audio=ffmpeg -i $1 -i $2 -c:v copy -map 0:v:0 -map 1:a:0 $3


doskey rec2=ffmpeg -f gdigrab -framerate 2 -video_size 1364x768 -i desktop out.mp4
doskey rec15=ffmpeg -f gdigrab -framerate 15 -video_size 1364x768 -i desktop out.mp4
doskey rec10=ffmpeg -rtbufsize 1024M -f gdigrab -i desktop -f dshow -i audio="Микрофон (Realtek High Definition Audio)" -f dshow -i "audio=virtual-audio-capturer" -filter_complex amix -y -ac 1 -r 10 -preset veryfast -crf 22 $1.mp4
doskey rec10=ffmpeg -rtbufsize 1024M -f gdigrab -framerate 10 -video_size 1366x768 -i desktop -f dshow -i audio="Микрофон (Realtek High Definition Audio)" -f dshow -i "audio=virtual-audio-capturer" -filter_complex amix -y -ac 1 -r 10 -preset veryfast -crf 22 $1.mp4
...
doskey recamv=ffmpeg.exe -y -f dshow -i video="screen-capture-recorder" -f dshow -i audio="virtual-audio-capturer" -f dshow -i audio="Микрофон (Realtek High Definition Audio)" -filter_complex "[1:0][2:0]amix=inputs=2:duration=shortest" -vcodec libx264 -preset veryfast -pix_fmt yuv420p -s 640x480 -r 8 -c:a aac -ab 64k -ac 2 -ar 16000 -f mp4 outputfile.mp4

doskey recam=ffmpeg.exe -y -f dshow -f dshow -i audio="virtual-audio-capturer" -f dshow -i audio="Микрофон (Realtek High Definition Audio)" -filter_complex "[1][0]amix=inputs=2:duration=shortest" $1.wav
doskey ffmpegkill=taskkill /IM ffmpeg.exe
...
::doskey dumpbin32="C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Tools\MSVC\14.16.27023\bin\Hostx86\x86\dumpbin.exe" $*
::doskey chrome="C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" $*
doskey sqlite="%USERPROFILE%\Documents\sqlite\sqlite3.exe" $*
::doskey wsldir=cd "C:\Users\2\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs"
doskey wsldir=pushd \\wsl$\Ubuntu-20.04\home
::doskey copy_wsldir =echo "C:\Users\2\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs" | clip
::doskey junction="C:\Users\2\Documents\Scripts\Junction\junction.exe"
doskey exp=explorer %CD% $*
:: Notice "%%h" instead of "%h" AND "%%x0D" in the end - a fix for batch script.
...
doskey keylog=cd %USERPROFILE%\Documents\Task-Stack-Widget\task-data\2780 $T$T C:\Python39\python.exe C:\Users\79951\Documents\Task-Stack-Widget\task-data\2780\keyboard-log-2.py

doskey winlog=cd %USERPROFILE%\Documents\Task-Stack-Widget $T$T C:\Python39\python.exe C:\Users\79951\Documents\Task-Stack-Widget\WindowWatcher.py
